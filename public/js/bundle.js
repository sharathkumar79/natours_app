...
var showAlert = function showAlert(status, msg) {
  var ele = "<div class =\"alert alert--".concat(status, "\">").concat(msg, "</div>");
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 14:
          ...
          _context.next = 18;
          return (0, _alert.showAlert)('error', 'error logged in');
        case 18:
          location.reload();
        case 19:
        case "end":
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          myHeaders = new Headers(); // myHeaders.append(
          //   'Cookie',
          ...
          _context2.prev = 2;
          _context2.next = 5;
          return fetch('http://127.0.0.1:3000/api/v1/users/logout', requestOptions);
        case 5:
          res = _context2.sent;
          console.log(res);
          location.assign('/overview');
...
},{"./alert.js":"alert.js"}],"updateUser.js":[function(require,module,exports) {
"use strict";
...
var updateUser = function updateUser(email, name, photo) {
  ...
  fetch('http://127.0.0.1:3000/api/v1/users/updateMe', requestOptions).then(function (response) {
...
var logotBtn = document.querySelector('.nav__el--logout');
var settingBtn = document.querySelector('.setting');
var passwordBtn = document.querySelector('.password');
if (form) form.addEventListener('submit', /*#__PURE__*/function () {
...
if (logotBtn) logotBtn.addEventListener('click', function (e) {
  e.preventDefault();
  (0, _login2.logout)();
});
if (settingBtn) settingBtn.addEventListener('click', function (e) {
  ...
  (0, _updateUser.updateUser)(email, name, photo);
});
},{"./login.js":"login.js","./login":"login.js","./updateUser":"updateUser.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "14689" + '/');
